...
const Footer = () => {
  return (
    <footer className="p-4 mt-10 bg-black rounded-lg w-100">
      <div className="md:flex">
        <div className="mb-6 md:mb-0 md:mt-20">
          <Link href="/">
            <Image src={logo} className="w-80 h-20 object-cover" alt="Yatri Energy Logo" />
          </Link>
          <div className="flex space-x-6 text-white md:ml-5">
        ...
        <div className="md:flex">
          <div className="m-20">
            ...
            <ul className="text-gray-400">
              ...
              <li>
                <a href="/green-city" className="hover:underline">
                  Our Green City
                </a>
              </li>
            </ul>
          </div>
          <div className="m-20 w-60">
            <ul className="text-gray-400">
              <li className="mb-4">
                <a href="/mission" className="hover:underline font-semibold text-white">
                  Our Mission
                </a>
              </li>
              <li className="mb-4">
              ...
              <li>
                <a href="/faq" className="hover:underline font-semibold text-white ">
                  FAQs
                </a>
              </li>
            </ul>
          ...
          <div className="m-20">
            ...
            <div className="flex">
              <input
                ...
                className="w-60 h-10 focus:outline-yatri-blue placeholder:font-bold placeholder:px-2 
                transition-all duration-500 ease-in-out outline:none
                "
              />
              <button className="bg-yatri-blue w-40 ml-2">Subscribe</button>
            </div>
          </div>
        </div>
      </div>
      <div className="sm:flex sm:items-center sm:justify-evenly">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
          <a href="https://yatrimotorcycles.com/" className="hover:underline">
            Yatri Energy
          </a>{' '}
          © 2023
        </span>
        <a href="#" className="hover:underline text-gray-400 mb-4">
          Privacy
        </a>
        <a href="#" className="hover:underline text-gray-400 mb-4">
          Terms of use
