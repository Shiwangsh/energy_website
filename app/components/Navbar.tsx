...
const Navbar = () => {
  return (
    <div className="absolute px-2 sm:px-4 py-2.5 rounded w-full text-white z-10">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="flex sm:flex-col sm:p-4 sm:mt-4 sm:border sm:border-gray-100 sm:rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-xl md:font-medium md:border-0 font-thin">
