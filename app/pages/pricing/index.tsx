  ...
  return (
    <div className="h-full w-full">
      ...
      <div className="md:flex md:justify-center md:items-center md:w-full w-auto md:m-0 mt-10 reveal fade-bottom">
        <div className="md:w-[25rem] md:h-[35rem] md:ml-20 md:relative md:top-[-5rem] md:m-0 mb-10 rounded-md border-yatri-blue p-2 shadow-2xl shadow/50 bg-white">
          <h1 className="text-2xl font-bold p-2 md:mt-4">Normal</h1>
          <p className="mb-4 p-2 text-justify">
        ...
        <div className="md:w-[25rem] md:h-[40rem] md:ml-20 md:relative md:top-[-6rem]  border-2 rounded-md border-yatri-blue bg-white p-2 shadow-lg shadow-yatri-blue/25">
          ...
          <h1 className="text-4xl font-bold mb-4 md:flex md:items-center m-2 md:flex-wrap ">
            Rs. 999<p className="font-normal text-sm mt-4">/month</p>
          </h1>
      ...
      <section className="w-full md:h-[30rem] md:flex md:items-center md:justify-center mt-20 md:mb-10 reveal fade-bottom">
        <div className="md:w-[30rem] md:h-[30rem] bg-[#1F1F1F]">
          <div className="flex-center flex-col h-full w-full ">
            <Image src={logo} alt="yatri logo" className="object-cover w-40" />
            <h1 className="text-white text-2xl">A Very Interesting Title</h1>
            <p className="m-6 text-center text-white leading-relaxed">
              We make freedom of travel possible. <br />
              Yatri Energy’s vision for the future is an open charging network that is accessible to every EV users.
              <br />
        ...
        <div className="md:w-[40rem] md:h-[30rem] bg-[#272727] flex items-center md:justify-center flex-col">
          ...
          <div className="m-4 flex  items-start  w-full">
            <BsFillCheckCircleFill className="m-2 text-yatri-blue" />
