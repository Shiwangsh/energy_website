          ...
          <div className="text-center group md:m-1">
            <Link href="/green-city">
              <Image
                src={one}
                alt="2"
                className="w-[30rem] h-[25rem] object-cover md:group-hover:brightness-50 transition duration-700  ease-in-out rounded-md"
              />
            </Link>
            <p className="md:group-hover:-translate-y-[10rem] transition duration-700 ease-in-out md:group-hover:text-white font-bold flex items-center justify-center m-5 md:m-0">
              Our Green City
